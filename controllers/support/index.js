...
router.post(
  "/inquirys/write",
  upload("inquirys").array("file", 5),
  csrfProtection,
  ctrl.post_inquirys_write
);
...
router.post(
  "/inquirys/reply/write/:id",
  csrfProtection,
  ctrl.post_inquirys_reply_write
);
router.post(
  "/inquirys/reply/edit/:id",
  csrfProtection,
  ctrl.post_inquirys_reply_edit
);
