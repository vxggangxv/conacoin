    ...
    <div style="width:70%; margin:0 auto; padding:40px; border:5px solid #eee; background-color:#fff; font-size:9pt; min-width:600px;">
        ...
        <div style="padding:50px 20px; background-color:#f5f5f1; text-align:center;">
            ...
            <div style="padding:20px; border:1px solid #eee; background-color:#fff; width:70%; margin:20px auto 0; word-break:break-all; white-space:breal-all;">
                <a style="color:#777; text-decoration: none;" href="${sign_url}">${sign_url}</a>
            </div>
 
            <p style="margin-top:20px;"><a style="padding:10px 30px; margin:0 auto; text-align:center; background-color:#333; color:#fff; border-radius:10px; font-size:9pt;" href="${process.env.SITE_DOMAIN}">EXPSHOP 노드쇼핑몰 바로가기</a></p>
 
            <p style="margin:0; padding:0; color:#999; margin-top:20px;">Copyright &copy; EXPSHOP 노드쇼핑몰 All Rights Reserved </p>
